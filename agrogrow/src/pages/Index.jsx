                        ...
                        <div class="container">
                            <div class="main-content">
                                <div class="w3lbanner-left">
                                    ...
                                    <h6>Welcome to AgroGrow</h6>
                                    <h4>Growing your crops, growing your profits</h4>
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-6 pe-lg-5">
                            ...
                            <ul class="service-list pt-lg-2 mt-4">
                                ...
                                <li class="service-link"><a href="#url"><span class="fa fa-check-circle"></span> Fresh
                                    Vegetables</a></li>
                                <li class="service-link"><a href="#url"><span class="fa fa-check-circle"></span>Easy To
                                    access</a></li>
                                <li class="service-link"><a href="#url"><span class="fa fa-check-circle"></span> Professional
                                    Team</a></li>
                            </ul>
                        </div>
                    ...
                    <div class="grids-of-3 row text-center">
                        <div class="col-lg-4 col-md-6 mt-5">
                            <div class="grids3-info">
                                <a href="#service" class="d-block zoom"><img src="assets/images/a4.jpg" alt=""
                                    class="img-fluid radius-image" /></a>
                                <div class="grids-of-3-saas-info">
                                    <h5><a href="#service" class="title">Crop Reccomendation</a></h5>
                        ...
                        <div class="col-lg-4 col-md-6 mt-5">
                            <div class="grids3-info">
                                <a href="#service" class="d-block zoom"><img src="assets/images/a5.jpg" alt=""
                                    class="img-fluid radius-image" /></a>
                                <div class="grids-of-3-saas-info">
                                    <h5><a href="#service" class="title">Fertilizer Reccomendation</a></h5>
                                    <p class="saas-para"> Venenatis eros et, sed commodo risus. Nullam sit
                                        amet laoreet elit.</p>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-4 col-md-6 mt-5">
                            <div class="grids3-info">
                                <a href="#service" class="d-block zoom"><img src="assets/images/a6.jpg" alt=""
                                    class="img-fluid radius-image" /></a>
                                <div class="grids-of-3-saas-info">
                                    <h5><a href="#service" class="title">Disease Prediction</a></h5>
                                    <p class="saas-para"> Venenatis eros et, sed commodo risus. Nullam sit
                                        amet laoreet elit.</p>
                                </div>
                            </div>
                        ...
                        <div class="row middle-section align-self">
                            <div class="col-lg-7 video-info pe-lg-5">
                                <div class="title-content text-left">
                                    ...
                                    <p class="mt-3 pe-lg-5">Lorem ipsum, dolor sit amet consectetur adipisicing elit.Lorem ipsum
                                        dolor sit amet elit
                                        consec tetur adipisi elit.
                                        Lorem ipsum dolor sit amet elit consec tetur adipisi elit. Iure voluptatibus explicabo
                                        officia.</p>
                                    <a href="contact.html" class="btn btn-style btn-outline-light mt-sm-5 mt-4">Discover
                                        More</a>
                                </div>
                            </div>
                            ...
                            <div class="progress-circles-grids">
                                <div class="progress-circles">
                                    <div class="progress-left">
                                        <div class="circle1">
                                            <div id="progress" data-dimension="80" data-text="85%" data-fontsize="18"
                                                data-percent="85" data-fgcolor="#006837" data-bgcolor="#f3f5f4" data-width="10"
                                                data-bordersize="4" data-animationstep="2">
                                            </div>
                                ...
                                <div class="progress-circles">
                                    <div class="progress-left">
                                        <div class="circle1">
                                            <div id="progress1" data-dimension="80" data-text="95%" data-fontsize="18"
                                                data-percent="95" data-fgcolor="#006837" data-bgcolor="#f3f5f4" data-width="10"
                                                data-bordersize="4" data-animationstep="2">
                                            </div>
                                        </div>
                                        <div class="progress-right">
            ...
            <div class="footer-29-w3l py-5">
                <div class="container pt-md-5">
                    <div class="w3l-footer-text-style">
                        <div class="footer-list-cont d-sm-flex align-items-center justify-content-between mb-5">
                            ...
                            <h2 class="w3logo"><a class="navbar-brand" href="index.html">
                                Agrow<span class="sub-color">Grow</span>
                            </a></h2>
                            <div class="main-social-footer-29">
                                <ul>
                                    <li><a href="https://facebook.com" class="facebook"><i
                                        class="fab fa-facebook-f"></i></a></li>
                                    <li><a href="https://twitter.com" class="twitter"><i class="fab fa-twitter"></i></a>
                                    </li>
                                    <li><a href="https://instagram.com/_mayank_ahuja" class="instagram"><i
                    ...
                    <div class="row footer-top-29 pt-lg-5 pt-sm-4">
                        <div class="col-lg-3 col-sm-6">
                            <div class="address-grid">
                                <h5>VIT Bhopal University<br /> Bhopal.</h5>
                        ...
                        <div class="col-lg-3 col-sm-6 mt-sm-0 mt-4 ps-lg-5">
                            <div class="address-grid">
                                <h5>Phone</h5>
                                <h5 class="phone-number-text mt-2"><a href="tel:+91 8305682466">+91 8305682466</a></h5>
                            </div>
                            <div class="address-grid mt-sm-5 mt-4">
                                <h5>E-mail</h5>
                                <h5 class="email-cont-text mt-1"> <a href="mailto:mayankahuja451@gmail.com"
                                    class="mail">mayankahuja451@gmail.com</a></h5>
                            </div>
                        </div>
                    ...
                    <div class="w3l-copyright text-center mt-lg-5 mt-sm-4 pt-md-4 pt-3">
                        <p class="copy-footer-29">© AgrowGrow. All rights reserved.
                        </p>
                    </div>
                </div>
            </div>
